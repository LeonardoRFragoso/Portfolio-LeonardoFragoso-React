    ...
    featuredProjects: {
      ...
      items: [
        ...
        },
        {
          id: 'pyscript',
          title: 'PyScript.Tech',
          role: 'Frontend / Institucional',
          problem: 'Uma software house precisa de presença digital premium que transmita credibilidade técnica e converta visitantes em leads qualificados.',
          solution: 'Site institucional moderno com design glassmorphism, animações refinadas, formulário de contato EmailJS e páginas de serviços/projetos.',
          architecture: 'React 18 · JavaScript · CSS Modules · EmailJS · Framer Motion',
          results: [
            'Identidade visual premium para software house',
            'Formulário de contato com integração direta',
            'Páginas de serviços e projetos com filtros',
          ],
        },
        {
          id: 'portfolio',
          title: 'Portfolio Leonardo Fragoso',
          role: 'Full Stack / SEO',
          problem: 'Recrutadores precisam rapidamente entender stack, experiência e projetos de um candidato backend em um único lugar otimizado.',
          solution: 'Portfólio profissional com SEO, prerender, internacionalização, CTAs de contato e apresentação curada de projetos e impacto técnico.',
          architecture: 'React 18 · TypeScript · Vite · Tailwind CSS · Framer Motion · SEO · Puppeteer',
          results: [
            'SEO local otimizado para Rio de Janeiro e backend Python',
            'Prerender para crawlers e indexação em buscadores',
            'CTAs de WhatsApp/Email para conversão de recrutadores',
          ],
        },
        {
          id: 'digitalsignage',
          title: 'TVS iTracker — Digital Signage',
          role: 'Backend Engineer / Enterprise',
          problem: 'Terminais de TV corporativa em porto operam de forma isolada, dificultando comunicação unificada e atualização de conteúdo em tempo real.',
          solution: 'Plataforma de TV Corporativa centralizada com comunicação em tempo real via WebSocket, compilação automática de vídeos e integração Chromecast.',
          architecture: 'Python · Flask · React · WebSocket · Redis · FFmpeg · Chromecast · Prometheus',
          results: [
            'TV corporativa implantada no maior terminal portuário privado do Brasil',
            'Comunicação em tempo real e atualização centralizada',
    ...
    featuredProjects: {
      ...
      items: [
        ...
        },
        {
          id: 'pyscript',
          title: 'PyScript.Tech',
          role: 'Frontend / Institutional',
          problem: 'A software house needs a premium digital presence that conveys technical credibility and converts visitors into qualified leads.',
          solution: 'Modern institutional website with glassmorphism design, refined animations, EmailJS contact form and services/projects pages.',
          architecture: 'React 18 · JavaScript · CSS Modules · EmailJS · Framer Motion',
          results: [
            'Premium visual identity for a software house',
            'Contact form with direct integration',
            'Services and projects pages with filters',
          ],
        },
        {
          id: 'portfolio',
          title: 'Leonardo Fragoso Portfolio',
          role: 'Full Stack / SEO',
          problem: 'Recruiters need to quickly understand a backend candidate\'s stack, experience and projects in a single optimized place.',
          solution: 'Professional portfolio with SEO, prerender, internationalization, contact CTAs and curated presentation of projects and technical impact.',
          architecture: 'React 18 · TypeScript · Vite · Tailwind CSS · Framer Motion · SEO · Puppeteer',
          results: [
            'Local SEO optimized for Rio de Janeiro and Python backend',
            'Prerender for crawlers and search engine indexing',
            'WhatsApp/Email CTAs for recruiter conversion',
          ],
        },
        {
          id: 'digitalsignage',
          title: 'TVS iTracker — Digital Signage',
          role: 'Backend Engineer / Enterprise',
          problem: 'Corporate TV terminals in a port operate in isolation, making unified communication and real-time content updates difficult.',
          solution: 'Centralized Corporate TV platform with real-time WebSocket communication, automatic video compilation and Chromecast integration.',
          architecture: 'Python · Flask · React · WebSocket · Redis · FFmpeg · Chromecast · Prometheus',
          results: [
            'Corporate TV deployed at Brazil\'s largest private port terminal',
            'Real-time communication and centralized updates',
            'Multi-company with Prometheus metrics',
          ],
        },
      ],
    },
